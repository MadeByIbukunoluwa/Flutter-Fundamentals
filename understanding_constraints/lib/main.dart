...
// This example class is an interface, recall that in dart, there is no specialized object for interfaes
                ...
                child: FittedBox(
                  ...
                  child: Column(children: [
                    ...
                    Container(
                        ...
                        width: double.infinity,
                        color: Colors.black,
                        // when scrolling on desktops vertically i get an error here
                        //"The Scrollbar's ScrollController has no ScrollPosition attached.",
                        // The error can be fixed using a Scroll Controller line 121
                        // https://github.com/flutter/flutter/issues/97873
                        //https://stackoverflow.com/questions/69853729/flutter-the-scrollbars-scrollcontroller-has-no-scrollposition-attached/71490688#71490688
                    ...
                    Container(
                        ...
                        // Remove the Scrollbar nesting here
                        // child: Scrollbar(
                        child: SingleChildScrollView(
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        ,
        Expanded(
          child: Container(color:green,child:Text("Goodbye!",style:big,))
        )
      ],
    );
  }
